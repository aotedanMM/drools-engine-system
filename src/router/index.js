...
export const constantRouterMap = [
  ...
  // 实时监测
  {
    path: '/',
    component: Layout,
    redirect: '/gasMonitoring',
    meta: { title: '实时气体监测', icon: 'monitor' },
    children: [
      {
        path: 'gasMonitoring',
        name: 'GasMonitoring',
  ...
  // 系统管理
  {
    path: '/',
    component: Layout,
    redirect: '/warnLevelManage',
    meta: { title: '警报等级管理', icon: 'dj' },
    children: [
      {
  ...
  },
  {
    path: '/',
    component: Layout,
    redirect: '/warnStandardManage',
    meta: { title: '警报标准管理', icon: 'standard' },
    children: [
      {
  ...
  },
  {
    path: '/',
    component: Layout,
    redirect: '/systemVoice',
    meta: { title: '系统声音管理', icon: 'voice' },
    children: [
      {
        path: 'systemVoice',
        name: 'SystemVoice',
